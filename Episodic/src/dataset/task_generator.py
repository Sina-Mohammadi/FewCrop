import torch
from dataset.utils_R import warp_tqdm, Logger
...
class Tasks_Generator:
    ...
    def generate_tasks(self):
        ...
        """
        tasks_dics = []
        for i, (data, labels, _) in enumerate(self.loader):#warp_tqdm(self.loader, False)):
            task = self.get_task(data[0], labels[0])
