...
```
## Data
Download the preprocessed data for the two scenarios from Zenedo using the following links: [scenario_1](https://zenodo.org/api/records/10802507/draft/files/scenario_1.rar/content) , [scenario_2](https://zenodo.org/api/records/10802507/draft/files/scenario_2.rar/content) - Then after unzipping them, put them in the data_fewcrop folder.
